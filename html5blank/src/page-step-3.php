...
<div class="wrapper-fluid">
        <section class="row">
          ...
          <article style="padding: 0;" class="col-lg-6 col-md-6 col-sm-12 col-xs-12 first-md first-lg first-xl last-xs last-sm p0">
            ...
            <aside class="col-lg-3 col-md-4 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2 first-sm first-xs"><script charset="utf-8" type="text/javascript" src="//js.hsforms.net/forms/shell.js"></script>
<script>
  hbspt.forms.create({
	region: "na1",
	portalId: "14544351",
