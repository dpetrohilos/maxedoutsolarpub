...
<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">    
<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/chart2.svg" alt="Homes with rooftop solar sell for thousands more">
</div>    
...
<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/chart4.svg" alt="Save $26,000 in 20 years on electrical costs">    
</div>    
