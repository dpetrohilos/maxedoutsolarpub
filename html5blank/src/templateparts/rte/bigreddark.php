<div class="wrapper-full bgdarkred">
    ...
    <section class="row">
        ...
        <h2 class="text-center hide-xl hide-lg show-md show-sm show-sm"> Be a part of the green energy future 
        </h2>
        <h2 class="hide-xs hide-sm hide-md show-lg show-xl"> While Be a part of the green energy future
        </h2>
...
<a class="btn" href="" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/max-neely/free-roof-check'});return false;">Make The Switch</a>
<!-- Calendly link widget end -->
