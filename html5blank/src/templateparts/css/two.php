...
<img width="1200" class="lazy responsive-img" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/family-2.jpg" alt="Family infront of a solar pannel happy to have a green future" />
...
<a title="Talk With Us" class="btn" href="" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/max-neely/free-roof-check'});return false;">Schedule an appointment</a>
<!-- Calendly link widget end -->
