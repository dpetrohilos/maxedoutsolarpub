...
<source class="lazy" sizes="(min-width: 40rem) 80vw, 100vw" 
 srcset="<?php echo esc_url( get_template_directory_uri() ); ?>/img/video-7.webp" type="image/webp" />        
...
<img width="624" class="responsive-img radius-both lazy" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/video-6@1.5x-50.jpg" alt="Featured video" />
