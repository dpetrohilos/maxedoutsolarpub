...
<source class="lazy" sizes="(min-width: 40rem) 80vw, 100vw" 
 srcset="<?php echo esc_url( get_template_directory_uri() ); ?>/img/family.webp" type="image/webp" />
<source class="lazy" srcset="<?php echo esc_url( get_template_directory_uri() ); ?>/img/family-3@0.25x.jpg" media="(min-width: 1000px)">
<source class="lazy" srcset="<?php echo esc_url( get_template_directory_uri() ); ?>/img/family-2@0.5x.jpg" media="(min-width: 800px)">
  
<img width="1200" class="lazy responsive-img" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/family.jpg" alt="Family infront of a solar pannel happy to have a green future" />
...
<img width="1200" class="responsive-img lazy" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/fam-2.jpg" alt="Happy child and dad in front of their community solar farm" />
