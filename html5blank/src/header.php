...
<section class="row">
					<!-- logo -->
					<div class="logo col-xl-2 col-lg-2 col-md-4 col-sm-8 col-xs-8 col-xl-offset-1 col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-4">
    ...
    <div class="nav-top icon col-lg-4 col-md-4 col-sm-12 col-xs-12 col-md-offset-2 col-lg-offset-4 col-xl-4">
